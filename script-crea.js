window.onload = function(){
	...
	var currentBg = "rgba(255,255,255,0.2)"
	...
	function createCanvas() {
		canvas.id = "canvas";
		canvas.width = parseInt(250)
		canvas.height = parseInt(400)
		/*if (window.screen.availWidth < 400){
		canvas.width = parseInt(300)
		canvas.height = parseInt(550)
		}else if (window.screen.availWidth > 1400){
		canvas.width = parseInt(370)
		canvas.height = parseInt(780)
		}*/

		/*canvas.width = parseInt(document.querySelector('#sixeX'));
		canvas.height = parseInt(document.querySelector('#sixeY')) */
...
/*document.getElementById("select__XS__item")?.addEventListener('click',function(){
	document.getElementById("select__XS__item").classList="select__XS__item--selected";
	document.getElementById("select__S__item").classList.remove("--selected");
	document.getElementById("select__M__item").classList.remove("--selected");
	document.getElementById("select__L__item").classList.remove("--selected");
	document.getElementById("select__XL__item").classList.remove("--selected");
});

document.getElementById("select__S__item").addEventListener('click',function(){
	document.getElementById("select__S__item").classList="--selected";
	document.getElementById("select__XS__item").classList.remove("--selected");
	document.getElementById("select__M__item").classList.remove("--selected");
	document.getElementById("select__L__item").classList.remove("--selected");
	document.getElementById("select__XL__item").classList.remove("--selected");
});

document.getElementById("select__M__item").addEventListener('click',function(){
	document.getElementById("select__M__item").classList="--selected";
	document.getElementById("select__S__item").classList.remove("--selected");
	document.getElementById("select__XS__item").classList.remove("--selected");
	document.getElementById("select__L__item").classList.remove("--selected");
	document.getElementById("select__XL__item").classList.remove("--selected");
...
document.getElementById("select__L__item").addEventListener('click',function(){
	document.getElementById("select__L__item").classList="--selected";
	document.getElementById("select__S__item").classList.remove("--selected");
	document.getElementById("select__M__item").classList.remove("--selected");
	document.getElementById("select__XS__item").classList.remove("--selected");
	document.getElementById("select__XL__item").classList.remove("--selected");
...
document.getElementById("select__XL__item").addEventListener('click',function(){
	document.getElementById("select__XL__item").classList="--selected";
	document.getElementById("select__S__item").classList.remove("--selected");
	document.getElementById("select__M__item").classList.remove("--selected");
	document.getElementById("select__L__item").classList.remove("--selected");
	document.getElementById("select__XS__item").classList.remove("--selected");
